...
class GlobalExceptionHandlerTest {
  ...
  void testHandleDuplicateEmailException() {
    ...
    ResponseEntity<ErrorResponse> response =
        globalExceptionHandler.handleDuplicateEmailException(ex, webRequest);
  ...
  void testHandleUsernameNotFoundException() {
    ...
    ResponseEntity<ErrorResponse> response =
        globalExceptionHandler.handleUsernameNotFoundException(ex, webRequest);
  ...
  void testHandleBadCredentialsException() {
    ...
    ResponseEntity<ErrorResponse> response =
        globalExceptionHandler.handleBadCredentialsException(ex, webRequest);
